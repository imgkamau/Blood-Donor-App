-- Blood Donor App Database Schema Creation (Without PostGIS)
...
-- Create the blood table in the donate schema (without PostGIS)
...
BEGIN
    ...
    RAISE NOTICE 'Note: Using latitude/longitude columns instead of PostGIS';
END $$;
